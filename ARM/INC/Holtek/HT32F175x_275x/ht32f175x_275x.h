...
/** @addtogroup HT32F175x_275x HT32F1755/1765/2755
  * @{
  */
...
/** @addtogroup Library_configuration_section
  ...
  */
/**
 * @brief Value of the Internal oscillator in Hz
  */
...
typedef struct
{
  ...
  __IO uint32_t LST[2];          /*!< 0x010 - 0x014 ADC (Regular) Conversion List Register 0-1              */
       uint32_t RESERVE2[6];     /*!< 0x018 - 0x02C Reserved                                                */
  ...
  __IO uint32_t DR[8];           /*!< 0x0B0 - 0x0CC ADC (Regular) Conversion Data Register 0-7              */
       uint32_t RESERVE5[12];    /*!< 0x0D0 - 0x0FC Reserved                                                */
...
#define HT_GPIOC_BASE            (HT_APB0PERIPH_BASE + 0x1C000)   /* 0x4001C000                             */
#define HT_GPIOD_BASE            (HT_APB0PERIPH_BASE + 0x1D000)   /* 0x4001D000                             */
#define HT_GPIOE_BASE            (HT_APB0PERIPH_BASE + 0x1E000)   /* 0x4001E000                             */
#define HT_AFIO_BASE             (HT_APB0PERIPH_BASE + 0x22000)   /* 0x40022000                             */
#define HT_EXTI_BASE             (HT_APB0PERIPH_BASE + 0x24000)   /* 0x40024000                             */
#define HT_MCTM_BASE             (HT_APB0PERIPH_BASE + 0x2C000)   /* 0x4002C000                             */

/* APB1                                                                                                     */
#define HT_USART1_BASE           (HT_APB1PERIPH_BASE + 0x0000)    /* 0x40040000                             */
#define HT_SCI_BASE              (HT_APB1PERIPH_BASE + 0x3000)    /* 0x40043000                             */
...
#define HT_USB_BASE              (HT_APB1PERIPH_BASE + 0xE000)    /* 0x4004E000                             */
#define HT_USB_EP0_BASE          (HT_USB_BASE        + 0x0014)    /* 0x4004E014                             */
#define HT_USB_EP1_BASE          (HT_USB_BASE        + 0x0028)    /* 0x4004E028                             */
#define HT_USB_EP2_BASE          (HT_USB_BASE        + 0x003C)    /* 0x4004E03C                             */
#define HT_USB_EP3_BASE          (HT_USB_BASE        + 0x0050)    /* 0x4004E050                             */
#define HT_USB_EP4_BASE          (HT_USB_BASE        + 0x0064)    /* 0x4004E064                             */
#define HT_USB_EP5_BASE          (HT_USB_BASE        + 0x0078)    /* 0x4004E078                             */
#define HT_USB_EP6_BASE          (HT_USB_BASE        + 0x008C)    /* 0x4004E08C                             */
#define HT_USB_EP7_BASE          (HT_USB_BASE        + 0x00A0)    /* 0x4004E0A0                             */
#define HT_USB_SRAM_BASE         (HT_APB1PERIPH_BASE + 0xE400)    /* 0x4004E400                             */
...
#define HT_MCTM                ((HT_MCTM_TypeDef *) HT_MCTM_BASE)
#define HT_SCI                 ((HT_SCI_TypeDef *) HT_SCI_BASE)
